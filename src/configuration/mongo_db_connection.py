...
class MongoDBClient:
    ...
    client = None # Shared MongoClient instance acros all MongoDBClient instances
    ...
    def __init__(self, database_name: str = DATABASE_NAME) -> None:
        ...
        ------
        MyException
            If there is an issue to MongoDB or if the environment variable for the MongoDB URL is not set. 
        """
        try:
            ...
            # Raise a custom exception with traceback details if conection fails.
