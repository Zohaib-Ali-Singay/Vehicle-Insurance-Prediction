...
MONGODB_URL_KEY = "mongodb+srv://zohaibalisingay8998_db_user:I0K5ag7YVDaweLD7@cluster0.8gyuwcv.mongodb.net/?appName=Cluster0"
...
MODEL_BUCKET_NAME = "my-model-mlopsproj-second"
