...
# Mount the 'static' directory for serving static file (like CSS)
...
class DataForm:
    """
    DataForm to handle and process incoming form data.
...
async def predictRouteClient(request: Request):
    """
    Endpoint to receive form data, proces it, and make a prediction.
    """
    try:
        ...
        # Interpret the prediction result as 'Response-Yes' or 'Repsonse-No'
        status = "Response-Yes" if value == 1 else "Repsonse-No"
